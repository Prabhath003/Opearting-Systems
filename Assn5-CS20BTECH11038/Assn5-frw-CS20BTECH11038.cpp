...
// semaphore just to print statements to log file with mutual exclusion
sem_t print;
...
int main()
{
    ...
    logfile.open("FairRW-log.txt", std::ios::out);
    if(!logfile)
    {
    ...
    waitTimeFile.open("FairRW-Average_time.txt", std::ios::out);
    if(!waitTimeFile)
    {
